...
esttab ad_dd ch_dd ad_men_dd ch_men_dd ad_women_dd ch_women_dd using PM25_DID_result.tex, b(4) se r2 star(* 0.10 ** 0.05 *** 0.05) title(DID Estimation (PM2.5)) replace

esttab ad_dd ch_dd ad_men_dd ch_men_dd ad_women_dd ch_women_dd,  star(* 0.10 ** 0.05 *** 0.05)   r2 se
